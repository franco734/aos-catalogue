#!/usr/bin/env python3
"""publier_oracle.py — Publication automatique des réponses Oracle
approuvées (voir ROADMAP.md du repo aos-explorer, section "Oracle des
